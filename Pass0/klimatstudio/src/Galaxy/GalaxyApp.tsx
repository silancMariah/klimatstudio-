...
import SatelliteUploadOverlay from './ui/SatelliteUploadOverlay';
...
import { GalaxyStationStage } from './scenes/Station/Components/GalaxyStationStage';

function AppContent() {
  const { currentScene, loadingProgress, customSatelliteModelUrl } = useSceneStore();
      ...
      >
        ...
        <Suspense fallback={<LoadingScreen />}>
          <>
            ...
            {currentScene === 'station' && <GalaxyStationStage modelUrl={customSatelliteModelUrl} />}
          </>
        </Suspense>
